from .handlers.evarsity import ConnHandler
from .handlers.evarsity import AppHandlers

from . import helpers

class Evarsity(object):
	status = None
	regno = None
	password = None
	semester = None
	...
	def __init__(self, payload):
		...
		if 'regno' not in keys:
			self.status = "Missing regno in payload"
			return
